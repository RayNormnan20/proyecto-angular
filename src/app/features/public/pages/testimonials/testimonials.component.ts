  ...
  template: `
    <div class="container mx-auto px-4 py-10">
      <div class="relative mb-8 text-center">
        ...
        <div class="absolute top-1/2 left-0 w-full h-[1px] bg-indigo-200 -z-0"></div>
      </div>

      <div *ngIf="testimonials().length > 0; else noTestimonials" class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div *ngFor="let item of testimonials()" class="group relative overflow-hidden rounded-lg shadow-sm border border-indigo-50 hover:shadow-md transition-all duration-300 hover:border-indigo-200">
          <!-- Image Container - Aspect Ratio 3:4 or Square -->
          <div class="aspect-[3/4] w-full overflow-hidden bg-indigo-50 relative">
            ...
            <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-indigo-900/90 via-indigo-900/50 to-transparent p-4 translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
